...
export default async function PageTableauDeBord() {
  ...
  const [nombreComptes, activites] = await Promise.all([
  ...
  return (
    <>
      ...
      >
        <IndicateurAVenir libelle="Apprenants actifs" phase={5} />
        <IndicateurAVenir libelle="Entreprises clientes" phase={4} />
